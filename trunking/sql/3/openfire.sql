...
1	admin@xmpp3.localhost.example	10
2	admin@xmpp3.localhost.example	10
\.
...
1	1	muc5@conference.xmpp3.localhost.example	\N	001590673309595		\N	<message type="groupchat" from="muc5@conference.xmpp3.localhost.example" to="muc5@conference.xmpp3.localhost.example"><subject></subject></message>
2	2	muc6@conference.xmpp3.localhost.example	\N	001590673327591		\N	<message type="groupchat" from="muc6@conference.xmpp3.localhost.example" to="muc6@conference.xmpp3.localhost.example"><subject></subject></message>
\.
...
1	1	001590673309589	001590673309606	muc5	MUC Five	Fifth MUC room	000000000000000	\N	0	30	1	0	0	0	\N	0	1		7	0	1	1	0	0	\N	\N	\N
1	2	001590673327588	001590673327593	muc6	MUC Six	Sixth MUC room	000000000000000	\N	0	30	1	0	0	0	\N	0	1		7	0	1	1	0	0	\N	\N	\N
\.
...
xmpp.domain	xmpp3.localhost.example	0	\N
...
dnsutil.dnsOverride	{xmpp1.localhost.example,172.50.0.150:5269},{conference.xmpp1.localhost.example,172.50.0.150:5269}	0	\N
\.
...
1	admin	1590673224063	Successful admin console login attempt	xmpp3.localhost.example	The user logged in successfully to the admin console from address 172.50.0.1. 
2	admin	1590673243764	created new user user5	xmpp3.localhost.example	name = User Five, email = null, admin = false
3	admin	1590673258818	created new user user6	xmpp3.localhost.example	name = User Six, email = null, admin = false
4	admin	1590673309619	created new MUC room muc5	xmpp3.localhost.example	subject = \nroomdesc = Fifth MUC room\nroomname = MUC Five\nmaxusers = 30
5	admin	1590673327602	created new MUC room muc6	xmpp3.localhost.example	subject = \nroomdesc = Sixth MUC room\nroomname = MUC Six\nmaxusers = 30
\.
...
user5	cJJTKnzGgri4mnJZl7ZRvmdKJSA=	tgCiLecUYoedW5ChDsNH3O31Rh4=	aWqE7RHOMIPk1OjXnQi1wclXTxgabNG9	4096	\N	\N	User Five	\N	001590673243733	001590673243733
user6	up8DR/iRy3dPy9Zt5s5Wnbga7Hk=	n46LRPiUcNrDolRx+AguJuSHezg=	ow0ZfSZnVCqFlPTcEXy4mmBSMNyLpLla	4096	\N	\N	User Six	\N	001590673258800	001590673258800
\.
