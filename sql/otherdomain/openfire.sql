...
1	admin@otherxmpp.localhost.example	10
2	admin@otherxmpp.localhost.example	10
\.
...
1	1	muc1@conference.otherxmpp.localhost.example	\N	001605193216988		\N	<message type="groupchat" from="muc1@conference.otherxmpp.localhost.example" to="muc1@conference.otherxmpp.localhost.example"><subject></subject></message>
2	2	muc2@conference.otherxmpp.localhost.example	\N	001605193235014		\N	<message type="groupchat" from="muc2@conference.otherxmpp.localhost.example" to="muc2@conference.otherxmpp.localhost.example"><subject></subject></message>
\.
...
pubsub		otherxmpp.localhost.example	owner
\.
...
pubsub		0	001605193079586	001605193079586	\N	0	0	0	0	1	1	1	0	0	publishers	1	0	open				otherxmpp.localhost.example		English		\N	all	-1
\.
...
1	user3	user1@otherxmpp.localhost.example	3	-1	-1	user1
2	user1	user3@otherxmpp.localhost.example	3	-1	-1	user3
3	user2	user1@otherxmpp.localhost.example	3	-1	-1	user1
4	user1	user2@otherxmpp.localhost.example	3	-1	-1	user2
5	user2	user3@otherxmpp.localhost.example	3	-1	-1	user3
6	user3	user2@otherxmpp.localhost.example	3	-1	-1	user2
\.
...
1	admin	1605193086180	Successful admin console login attempt	otherxmpp.localhost.example	The user logged in successfully to the admin console from address 172.60.0.1. 
2	admin	1605193167191	created new user user1	otherxmpp.localhost.example	name = User One, email = null, admin = false
3	admin	1605193178661	created new user user2	otherxmpp.localhost.example	name = User Two, email = null, admin = false
4	admin	1605193216992	created new MUC room muc1	otherxmpp.localhost.example	subject = \nroomdesc = First MUC room\nroomname = MUC One\nmaxusers = 30
5	admin	1605193235018	created new MUC room muc2	otherxmpp.localhost.example	subject = \nroomdesc = Second MUC room\nroomname = MUC Two\nmaxusers = 30
6	admin	1605957429200	created new user user3	otherxmpp.localhost.example	name = null, email = null, admin = false
\.
